...
-   Create a tree using IQTree2 _(-T 8 -m GTR+I+G)_ and annotate branches belonging to the focal clade (2.3.4.4b) with 2.3.4.4b using the [LabelTree.bf script](https://github.com/veg/hyphy/blob/master/res/TemplateBatchFiles/lib/label-tree.bf) in HyPhy v2.5.62
